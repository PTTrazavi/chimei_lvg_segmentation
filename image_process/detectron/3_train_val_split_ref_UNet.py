...
import json
# set folder paths
UNet_folder = "chimei_4626_514/train"
...
val_dict = {}
val_keys = []
# get UNet training image list
UNet_image_list = [i for i in os.listdir(UNet_folder) if not i.startswith('.')]
print("total UNet images:", len(UNet_image_list))
